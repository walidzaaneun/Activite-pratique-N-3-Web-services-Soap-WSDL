 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://webservice.walidzaaneun.com/", wsdlLocation = "http://localhost:8686/?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUEWS_QNAME = new QName("http://webservice.walidzaaneun.com/", "BanqueWS");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://webservice.walidzaaneun.com/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.walidzaaneun.com/", "BanqueServicePort"), BanqueService.class, features);
    }
